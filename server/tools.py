"""STRIDE threat modelling tool implementations.

Each function returns a framework, rubric, or template for the client's LLM to
populate; none of them perform the analysis themselves. See MCP_DESIGN_PRINCIPLES.md.
"""
